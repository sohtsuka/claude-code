...
# install:- channel: stable; cliVersion: 5.22.4; cliNativeVersion: 0.7.32; api: https://api.sdkman.io/2
...
export SDKMAN_VERSION="5.22.4"
export SDKMAN_NATIVE_VERSION="0.7.32"
